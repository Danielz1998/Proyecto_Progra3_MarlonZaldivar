...
SDL_Event Event;
SDL_Texture *background,*character,*Logo,*enemy,*colis,*vgano;
SDL_Rect rect_background,rect_character,rect_Logo,rect_enemy,rect_colis,rect_vgano;
...
void ventanagano()
{
    ...
    ofstream archivo ("Resultados Juego.txt");
